...
gh workflow run build-artifact.yml -f 'os=ubuntu-24.04, ubuntu-22.04, ubuntu-20.04, macos-12' -f 'verbose=true' -f 'create-pr-merge-artifact-branch=true' --ref ${BRANCH}
