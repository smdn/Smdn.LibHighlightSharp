...
public class CodeGenerator : global::System.IDisposable {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(CodeGenerator obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public void setIndentGuides(bool b) {
    highlightPINVOKE.CodeGenerator_setIndentGuides(swigCPtr, b);
  }
  ...
  public void setSkipLeadingCols(uint cols) {
    highlightPINVOKE.CodeGenerator_setSkipLeadingCols(swigCPtr, cols);
  }

  public void insertLineHead() {
    highlightPINVOKE.CodeGenerator_insertLineHead(swigCPtr);
  }
  ...
  public virtual string getHoverTagOpen(string arg0) {
    string ret = highlightPINVOKE.CodeGenerator_getHoverTagOpen(swigCPtr, arg0);
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
