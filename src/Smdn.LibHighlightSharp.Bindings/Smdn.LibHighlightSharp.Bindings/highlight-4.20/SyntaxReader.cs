...
public class SyntaxReader : global::System.IDisposable {
  ...
  public bool needsReload(SWIGTYPE_p_std__string_view langDefPath) {
    bool ret = highlightPINVOKE.SyntaxReader_needsReload(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(langDefPath));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public bool isKeyword(SWIGTYPE_p_std__string_view s) {
    bool ret = highlightPINVOKE.SyntaxReader_isKeyword(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(s));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public int getKeywordListGroup(SWIGTYPE_p_std__string_view s) {
    int ret = highlightPINVOKE.SyntaxReader_getKeywordListGroup(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(s));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public SWIGTYPE_p_std__mapT_std__string_int_std__lessT_t_t getKeywords() {
    SWIGTYPE_p_std__mapT_std__string_int_std__lessT_t_t ret = new SWIGTYPE_p_std__mapT_std__string_int_std__lessT_t_t(highlightPINVOKE.SyntaxReader_getKeywords(swigCPtr), false);
    return ret;
  }
  ...
  public void restoreLangEndDelim(SWIGTYPE_p_std__string_view langPath) {
    highlightPINVOKE.SyntaxReader_restoreLangEndDelim(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(langPath));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool allowsInnerSection(SWIGTYPE_p_std__string_view langPath) {
    bool ret = highlightPINVOKE.SyntaxReader_allowsInnerSection(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(langPath));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public string getOverrideConfigVal(SWIGTYPE_p_std__string_view name) {
    string ret = highlightPINVOKE.SyntaxReader_getOverrideConfigVal(swigCPtr, SWIGTYPE_p_std__string_view.getCPtr(name));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void addPersistentKeyword(uint groupID, SWIGTYPE_p_std__string_view kw) {
    highlightPINVOKE.SyntaxReader_addPersistentKeyword(swigCPtr, groupID, SWIGTYPE_p_std__string_view.getCPtr(kw));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void addPersistentStateRange(uint groupID, uint column, uint length, uint lineNumber, SWIGTYPE_p_std__string_view fileName) {
    highlightPINVOKE.SyntaxReader_addPersistentStateRange(swigCPtr, groupID, column, length, lineNumber, SWIGTYPE_p_std__string_view.getCPtr(fileName));
    if (highlightPINVOKE.SWIGPendingException.Pending) throw highlightPINVOKE.SWIGPendingException.Retrieve();
  }
