...
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_26_04_X64): CXX := g++
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_26_04_X64): CFLAGS := $(CFLAGS_COMMON) -m64
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_26_04_X64): LDFLAGS := -shared
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_26_04_X64):
	$(MAKE) -f $(THIS_FILE) \
	  CXX="$(CXX)" \
	  CFLAGS="$(CFLAGS)" \
	  LDFLAGS="$(LDFLAGS)" \
...
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_24_04_X64): CXX := g++
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_24_04_X64): CFLAGS := $(CFLAGS_COMMON) -m64
$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_24_04_X64): LDFLAGS := -shared
