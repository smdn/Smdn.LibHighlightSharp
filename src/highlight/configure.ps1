...
function Build-ConfigMk {
  ...
  $lines += "NATIVE_BINARY_OUTPUT_PATH_UBUNTU_26_04_X64 := ${NATIVE_BINARY_OUTPUT_BASEDIR}ubuntu.26.04-x64/native/lib${BINDINGS_DLLIMPORTNAME}.so"
  ...
  #
  if (
    [System.Runtime.InteropServices.RuntimeInformation]::RuntimeIdentifier.StartsWith('ubuntu.26.04-x64') -or
    [System.Runtime.InteropServices.RuntimeInformation]::OSDescription.StartsWith('Ubuntu 26.04')
  ) {
    # Target 'ubuntu.26.04-x64' and 'win-x64'(+lua.dll)
    $artifact_rid = "ubuntu.26.04-x64"
  ...
  elseif (
    ...
    $lines += "NATIVE_BINARIES := `$(NATIVE_BINARY_OUTPUT_PATH_UBUNTU_24_04_X64)"
  }
  elseif (
