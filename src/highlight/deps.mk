...
$(LUA_DLL_WINDOWS_X64):
	...
	cd $(MINGW_LUA_DLL_DIR_WINDOWS_X64) && \
	  curl --no-progress-meter --silent --show-error --remote-name --remote-header-name --location https://sourceforge.net/projects/luabinaries/files/$(LUA_VERSION_WINDOWS)/Windows%20Libraries/Dynamic/$(LUA_ZIP_WINDOWS_X64)/download && \
